 ...
 * {@linkplain MyFastBufferedInputStream.LineTerminator line terminators} that
 * delimit lines.
 *
 * </ul>
 *
...
public class MyFastBufferedInputStream extends MeasurableInputStream implements RepositionableStream {
   ...
   */
  public MyFastBufferedInputStream( final InputStream is, final byte[] buffer ) {
    this.is = is;
   ...
   */
  public MyFastBufferedInputStream( final InputStream is, final int bufferSize ) {
   ...
   * @param is an input stream to wrap.
   */
  public MyFastBufferedInputStream( final InputStream is ) {
   ...
   *
   * <p>As explained in the {@linkplain MyFastBufferedInputStream class documentation}, the semantics
